...
var Flex = React__default['default'].forwardRef(function (_a, ref) {
    var children = _a.children, style = _a.style, className = _a.className, options = __rest(_a, ["children", "style", "className"]);
    var row = options.row, vCenter = options.vCenter, hCenter = options.hCenter, flex1 = options.flex1, h100 = options.h100, w100 = options.w100, onClick = options.onClick, otherProps = __rest(options, ["row", "vCenter", "hCenter", "flex1", "h100", "w100", "onClick"]);
    var styles = {
        flexBox: {
            display: 'flex',
    ...
    return (React__default['default'].createElement("div", __assign({}, otherProps, { onClick: onClick, ref: ref, className: className, style: __assign(__assign(__assign({}, styles.flexBox), conditionalStyles), style) }), children));
});
...
var FilledInput$1 = withStyles(styles$l, {
  name: 'MuiFilledInput'
})(FilledInput);
...
var OutlinedInput$1 = withStyles(styles$j, {
...
var InputLabel$1 = withStyles(styles$h, {
  name: 'MuiInputLabel'
})(InputLabel);
...
var Modal$1 = /*#__PURE__*/React__namespace.forwardRef(function Modal(inProps, ref) {
...
var Paper$1 = withStyles(styles$b, {
  name: 'MuiPaper'
})(Paper);
...
var Popover = /*#__PURE__*/React__namespace.forwardRef(function Popover(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(Modal$2, _extends({
    container: container,
    open: open,
    ref: ref,
    BackdropProps: {
...
var Menu = /*#__PURE__*/React__namespace.forwardRef(function Menu(props, ref) {
  ...
  }, other), /*#__PURE__*/React__namespace.createElement(MenuList$1, _extends({
...
var Menu$1 = withStyles(styles$8, {
  name: 'MuiMenu'
})(Menu);
...
var SvgIcon$1 = withStyles(styles$7, {
  name: 'MuiSvgIcon'
})(SvgIcon);
...
var Select$1 = withStyles(styles$5, {
  name: 'MuiSelect'
})(Select);
...
var css_248z$1 = ".Form-module_form__1M_WK {\n  display: flex;\n  flex-direction: column; }\n  .Form-module_form__1M_WK > input[type='submit'] {\n    background-color: transparent;\n    border: 1px solid #4444;\n    border-radius: 5px;\n    padding: 5px 0;\n    width: 80%;\n    margin: 10px auto; }\n\n.Form-module_title__3OOVv {\n  margin: 10px;\n  font-size: 2em; }\n";
var styles$3 = {"form":"Form-module_form__1M_WK","title":"Form-module_title__3OOVv"};
styleInject(css_248z$1);

var formValidator = function (fieldsTests) {
    var cachedValues = {};
    return {
        errors: function (fieldName) {
            return ((fieldsTests[fieldName] || [])
                .map(function (test) { return test(cachedValues[fieldName]); })
                .find(function (result) { return result; }) || false);
        },
        checkErrors: function (formData) {
            Object.assign(cachedValues, formData);
            return Object.entries(fieldsTests).some(function (_a) {
                var key = _a[0], tests = _a[1];
                return key && tests.length && tests.some(function (test) { return test(formData[key]); });
            });
        },
    };
};
var fieldValidators = {
    minLength: function (n) {
        return function (val) {
            return (val === null || val === void 0 ? void 0 : val.length) < n && "This field has to be at least " + n + " characters long";
        };
    },
    maxLength: function (n) {
        return function (val) {
            return (val === null || val === void 0 ? void 0 : val.length) > n && "This field has to be at most " + n + " characters long";
        };
    },
    isRequired: function (val) { return !val && 'This field is required'; },
    isType: function (type) {
        return function (val) {
            return typeof val !== type && "This field should be of type " + type;
        };
    },
    matches: function (otherValue, valuesName) {
        return function (value) {
            return value !== otherValue && (valuesName || 'Values') + " do not match";
        };
    },
};
...
var StyledGrid = withStyles(styles$2, {
  name: 'MuiGrid'
})(Grid);
...
function Form(_a) {
    var fields = _a.fields, title = _a.title, onSubmit = _a.onSubmit;
    var _b = React.useState(false), showErrors = _b[0], setShowErrors = _b[1];
    var fieldValidators$1 = fields.reduce(function (fv, f) {
        var _a;
        var _b;
        if (typeof f === 'object' && ((_b = f === null || f === void 0 ? void 0 : f.validators) === null || _b === void 0 ? void 0 : _b.length)) {
            return __assign(__assign({}, fv), (_a = {}, _a[f.name] = f.validators, _a));
        }
        return fv;
    }, {});
    var validator = React.useRef(formValidator(fieldValidators$1));
    // useEffect(() => {
    //   validator.current = formValidator(fieldValidators)
    // }, [])
    return (React__default['default'].createElement(Flex, { column: true },
        React__default['default'].createElement(Flex, { className: styles$3.title }, title),
        React__default['default'].createElement("form", { className: styles$3.form, onSubmit: function (e) {
                e.preventDefault();
                var formData = Object.fromEntries(new FormData(e.target).entries());
                var errors = validator.current.checkErrors(formData);
                setShowErrors(true);
                if (!errors) {
                    onSubmit(formData);
                }
            } },
            React__default['default'].createElement(Grid$1, { container: true, spacing: 2, direction: 'column', alignItems: 'center' },
                fields.map(function (f) {
                    var _a;
                    if (typeof f === 'string') {
                        return (React__default['default'].createElement(Grid$1, { item: true, key: f },
                            React__default['default'].createElement(TextField$1, { error: showErrors, id: f, label: f })));
                    }
                    else {
                        var errorText = showErrors && validator.current.errors(f.name);
                        return (React__default['default'].createElement(Grid$1, { item: true, key: f.name },
                            React__default['default'].createElement(TextField$1, { type: f.type === 'password' ? 'password' : undefined, name: f.name, multiline: f.multiline, error: !!errorText, id: f.name, label: f.title || f.emphasis || f.name, defaultValue: f.defaultValue, helperText: errorText, variant: 'outlined', required: (_a = f === null || f === void 0 ? void 0 : f.validators) === null || _a === void 0 ? void 0 : _a.includes(fieldValidators.isRequired) })));
                    }
                }),
                React__default['default'].createElement(Grid$1, { item: true, key: 'submit' },
                    React__default['default'].createElement("input", { type: 'submit' }))))));
}

var css_248z = ".Modal-module_Modal__3BJiI {\n  width: 100vw;\n  height: 100vh;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background-color: #0002;\n  z-index: 100;\n  position: absolute;\n  top: 0;\n  left: 0; }\n\n.Modal-module_modalWindow__1mH3X {\n  border-radius: 15px;\n  padding: 25px;\n  background-color: white;\n  min-width: 50px;\n  min-height: 50px; }\n";
var styles$1 = {"Modal":"Modal-module_Modal__3BJiI","modalWindow":"Modal-module_modalWindow__1mH3X"};
styleInject(css_248z);

var Modal = function (_a) {
    var children = _a.children, dismissable = _a.dismissable, visible = _a.visible, close = _a.close;
    return visible === false ? null : (React__default['default'].createElement("div", { className: styles$1.Modal, onClick: dismissable ? close : undefined },
        React__default['default'].createElement("div", { className: styles$1.modalWindow, onClick: function (e) { return e.stopPropagation(); } }, children)));
};
...
var Spinner = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, { hCenter: true, h100: true, v100: true, vCenter: true },
        text && React__default['default'].createElement("h2", null, text),
        React__default['default'].createElement(CircularProgress$1, { size: size || 30 })));
};
