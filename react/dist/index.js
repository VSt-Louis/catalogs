...
var Flex = React__default.forwardRef(function (_a, ref) {
    ...
    return (React__default.createElement("div", __assign({}, otherProps, { onClick: onClick, ref: ref, className: className, style: __assign(__assign(__assign({}, styles.flexBox), conditionalStyles), style) }), children));
});
...
var Modal$1 = /*#__PURE__*/React.forwardRef(function Modal(inProps, ref) {
...
function Form(_a) {
    ...
    var _b = useState(false), showErrors = _b[0], setShowErrors = _b[1];
    ...
    var validator = useRef(formValidator(fieldValidators$1));
    // useEffect(() => {
    //   validator.current = formValidator(fieldValidators)
    // }, [])
    return (React__default.createElement(Flex, { column: true },
        React__default.createElement(Flex, { className: styles$3.title }, title),
        React__default.createElement("form", { className: styles$3.form, onSubmit: function (e) {
                e.preventDefault();
            ...
            React__default.createElement(Grid$1, { container: true, spacing: 2, direction: 'column', alignItems: 'center' },
                fields.map(function (f) {
                    var _a;
                    if (typeof f === 'string') {
                        return (React__default.createElement(Grid$1, { item: true, key: f },
                            React__default.createElement(TextField$1, { error: showErrors, id: f, label: f })));
                    }
                    else {
                        var errorText = showErrors && validator.current.errors(f.name);
                        return (React__default.createElement(Grid$1, { item: true, key: f.name },
                            React__default.createElement(TextField$1, { type: f.type === 'password' ? 'password' : undefined, name: f.name, multiline: f.multiline, error: !!errorText, id: f.name, label: f.title || f.emphasis || f.name, defaultValue: f.defaultValue, helperText: errorText, variant: 'outlined', required: (_a = f === null || f === void 0 ? void 0 : f.validators) === null || _a === void 0 ? void 0 : _a.includes(fieldValidators.isRequired) })));
                    }
                }),
                React__default.createElement(Grid$1, { item: true, key: 'submit' },
                    React__default.createElement("input", { type: 'submit' }))))));
}
...
var Modal = function (_a) {
    ...
    return visible === false ? null : (React__default.createElement("div", { className: styles$1.Modal, onClick: dismissable ? close : undefined },
        React__default.createElement("div", { className: styles$1.modalWindow, onClick: function (e) { return e.stopPropagation(); } }, children)));
};
...
var Spinner = function (_a) {
    ...
    return (React__default.createElement(Flex, { hCenter: true, h100: true, v100: true, vCenter: true },
        text && React__default.createElement("h2", null, text),
        React__default.createElement(CircularProgress$1, { size: size || 30 })));
};

export { Flex, Form, Modal, Spinner };
